...
#    Updated: 2021/01/28 12:00:05 by wiozsert         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(PATHLIBFT)ft_itoa.c $(PATHLIBFT)ft_strlen.c $(PATHLIBFT)ft_uitoa.c \
$(PATHLIBFT)addr_or_hex_conversion.c $(PATHLIBFT)get_len_of_conversion.c \
$(PATHLIBFT)ft_strsjoin.c
...
$(PATHLIBFT)ft_itoa.o $(PATHLIBFT)ft_strlen.o $(PATHLIBFT)ft_uitoa.o \
$(PATHLIBFT)addr_or_hex_conversion.o $(PATHLIBFT)get_len_of_conversion.o \
$(PATHLIBFT)ft_strsjoin.o
...
FILESOLIBFT = buffer_memset.o ft_atoi.o ft_itoa.o ft_strlen.o ft_uitoa.o \
addr_or_hex_conversion.o get_len_of_conversion.o ft_strsjoin.o
